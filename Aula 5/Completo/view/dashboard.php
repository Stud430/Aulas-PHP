...
<?php
       ...
       $sql = "SELECT id_usuario,login, senha FROM usuarios WHERE id_usuario = $id";// WHERE id_usuario = $_SESSION['idUser']";
      ...
      <td><center><a class="btn btn-warning" href="atualizacao.php?id=<?php echo $exibir["id_usuario"]?>"> <img src="atualizar.png" id="img_atualizar"> </a> </center></td> <!-- envia o id para a URL -->
      <td><center><a class="btn btn-danger" href="../model/deletar.php?id=<?php echo $exibir["id_usuario"]?>"> <img src="deletar.png" id="img_deletar"> </a></center></td>
